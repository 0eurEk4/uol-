...
{   
    ...
    orders.push_back(   OrderBookEntry{100000, 
                        0.02, 
    ...
    // this iteration is called called by reference
    {
        std::cout << "The price is " << order.price << std::endl;
    }

   for(unsigned int i = 0; i < orders.size(); ++i) 
   // ++i is more efficient than i++, it uses classic array style syntax
   {
        std::cout << "The price is " << orders[i].price << std::endl;
   }

   for(unsigned int i = 0; i < orders.size(); ++i) 
   // this iteration uses object style array accessing.
   {
